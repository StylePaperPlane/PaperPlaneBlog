...
public class CustomEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    private static final String CONFIG_KEY_COLUMN = "config_key";

    private static final String CONFIG_VALUE_COLUMN = "config_value";
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        try {
            ...
            log.warn("Failed to load sys_config from database, continuing with file/environment configuration.", e);
        }
    }
}
