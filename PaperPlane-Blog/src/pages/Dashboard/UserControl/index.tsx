...
const normalizeWebInfo = (data?: Partial<webInfo>): webInfo => {
    const next = {...defaultWebInfo, ...data};
...
const UserControl = () => {
    ...
    const [webInfo, setWebInfo] = useState<webInfo>(defaultWebInfo);
    ...
    const getSetting = () => {
        http({
            ...
            if(res.status === 200){
                setWebInfo(normalizeWebInfo(res.data.data))
            }
        })
    }
